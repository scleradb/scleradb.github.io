...
![ScleraViz Examples](/assets/images/scleraviz-examples.jpg "Visualization Examples")
![ScleraViz Bar Example](/assets/images/scleraviz-bar.jpg "Bar Example")
...
You can run the examples appearing below on the Sclera shell -- either installed in your machine, or [online at http://www.scleradb.com/shell](/shell). To start, set up the `tips` table as follows:
...
![Simple Plot](/assets/images/visualization/sclera-scatter-simple.jpg "Simple Plot")
...
![Simple Bar Chart](/assets/images/visualization/sclera-simple-bar.jpg "Simple Bar Chart")
...
![Simple Line Chart](/assets/images/visualization/sclera-simple-line.jpg "Simple Line Chart")
...
![Scatter Plot with Non-default Aesthetics](/assets/images/visualization/sclera-scatter-legends.jpg "Scatter Plot with Non-default Aesthetics")
...
![Line Chart with Groups](/assets/images/visualization/sclera-group-line.jpg "Line Chart with Groups")
...
![With `KEY=day`](/assets/images/visualization/sclera-key.jpg "With `KEY=day`, each row updates the existing bar")
...
![Without `KEY=day`](/assets/images/visualization/sclera-nokey.jpg "Without `KEY=day`, each row creates a new bar")
...
![Grouped Bar Chart](/assets/images/visualization/sclera-bar-dodge.jpg "Grouped Bar Chart")
...
![Stacked Bar Chart](/assets/images/visualization/sclera-bar-stack.jpg "Stacked Bar Chart")
...
![LOESS Smoothing](/assets/images/visualization/sclera-stat-loess.jpg "Loess Smoothing")
...
![Marked Regions](/assets/images/visualization/sclera-mark.jpg "Marked Regions")
...
![Multi-Layer Plot](/assets/images/visualization/sclera-multilayer.jpg "Multi-Layer Plot")
...
![Another Multi-Layer Plot](/assets/images/visualization/sclera-multilayer-alt.jpg "Another Multi-Layer Plot")
...
![Multiple Plots](/assets/images/visualization/sclera-multiplot.jpg "Multiple Plots")
...
![Multiple Plots with Aligned Layout](/assets/images/visualization/sclera-multiplot-aligned.jpg "Multiple Plots with Aligned Layout")
...
![Multiple Plots with Aligned Layout and Weighted Axes](/assets/images/visualization/sclera-multiplot-aligned-weighted.jpg "Multiple Plots with Aligned Layout and Weighted Axes")
...
![Cross Plot with Aligned Layout](/assets/images/visualization/sclera-cross-plot-aligned.jpg "Cross Plot with Aligned Layout")
...
![Faceted Plot](/assets/images/visualization/sclera-faceted.jpg "Faceted Plot")
